...
parcelHelpers.export(exports, "fristInit", ()=>fristInit);
// SCROLL ANIMATION
parcelHelpers.export(exports, "scrollAnim", ()=>scrollAnim);
// NAVBAR BUTTONS
parcelHelpers.export(exports, "navButtons", ()=>navButtons);
// PROJECTS
parcelHelpers.export(exports, "projectsAnim", ()=>projectsAnim);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _all = require("gsap/all");
(0, _gsapDefault.default).registerPlugin((0, _all.ScrollToPlugin), (0, _all.ScrollTrigger));
// LOAD ANIMATION
...
function scrollAnim() {
    ...
    if (scrollY > 350) header.style.position = "absolute";
    ...
    orderPairs.forEach((pair, orderIndex)=>{
        ...
        if (scrollY > startScroll) {
            ...
            const moveFactorSmall = Math.min(1, (scrollY - startScroll - 60) / sectionHeight);
            const translateY = -moveFactor * header.offsetHeight - 4;
            const translateYsmall = -moveFactorSmall * smallLetterContainer.offsetHeight + 37;
            pair.forEach((idx)=>{
                const letter = letters[idx];
                (0, _gsapDefault.default).to(letter, {
                    y: translateY
                });
                const smallLetter = smallLetters[idx];
                (0, _gsapDefault.default).to(smallLetter, {
                    y: translateYsmall
                });
            });
        } else pair.forEach((idx)=>{
            const letter = letters[idx];
            (0, _gsapDefault.default).to(letter, {
                y: 0
            });
...
function projectsAnim() {
    (0, _gsapDefault.default).to("#dulcinea", {
        scrollTrigger: {
            trigger: "#dulcinea",
            start: "-=1%",
            endTrigger: "#about",
    ...
    (0, _gsapDefault.default).to("#cv-design", {
        scrollTrigger: {
            trigger: "#cv-design",
            start: "-=3%",
            endTrigger: "#about",
...
},{"gsap":"fPSuC","gsap/all":"3UJRo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","./CustomEase.js":false,"./Draggable.js":false,"./CSSRulePlugin.js":false,"./EaselPlugin.js":false,"./EasePack.js":false,"./Flip.js":false,"./MotionPathPlugin.js":false,"./Observer.js":false,"./PixiPlugin.js":false,"./ScrollToPlugin.js":"9xJDW","./ScrollTrigger.js":"7wnFk","./TextPlugin.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aAWxM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Observer.js":"aAWxM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iWvxK","bNKaB"], "bNKaB", "parcelRequire405f")
